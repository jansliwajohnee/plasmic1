...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: tbgq9mOZKu0a/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns___62RcM)}>
        <div className={classNames(projectcss.all, sty.column__v4YrS)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__y2N6C)}>
          <div className={classNames(projectcss.all, sty.columns___6BPb)}>
            <div className={classNames(projectcss.all, sty.column__bdEc2)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__m4H16)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__mpXhE)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox___9PgT8)}>
                {renderPlasmicSlot({
