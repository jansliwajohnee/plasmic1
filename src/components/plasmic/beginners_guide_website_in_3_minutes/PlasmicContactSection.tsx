...
import sty from "./PlasmicContactSection.module.css"; // plasmic-import: 0ksaRVFy-T38/css

import RightArrowIcon from "./icons/PlasmicIcon__RightArrow"; // plasmic-import: MMcm4jy7mPYy/icon
...
function PlasmicContactSection__RenderFunc(props: {
  ...
  return (
    <Stack__
      ...
      id={"contact"}
    >
      <div className={classNames(projectcss.all, sty.freeBox__kLfh2)}>
        <h2
        ...
        <div className={classNames(projectcss.all, sty.freeBox__kBlT)}>
          <PlasmicLink__
